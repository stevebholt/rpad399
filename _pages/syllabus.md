...
After working with the professor to select a broad topic with a set of potential research questions, students will be taught to conduct a literature review. The first draft of their literature review - a minimum of 5 pages and a maximum of 10 pages - should trace the theoretical debates about the topic from its origin and into recent years, summarize the empirical evidence (if any) from prior research, and outline the remaining open questions to be answered in this body of work.
